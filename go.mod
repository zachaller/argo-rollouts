...
require (
	...
	github.com/newrelic/newrelic-client-go/v2 v2.81.0
...
replace (
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.34.5
	k8s.io/sample-controller => k8s.io/sample-controller v0.34.5
)
