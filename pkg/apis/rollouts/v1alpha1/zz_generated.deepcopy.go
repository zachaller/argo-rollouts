...
func (in *CanaryStep) DeepCopyInto(out *CanaryStep) {
	*out = *in
	...
	if in.SetHeaderRouting != nil {
		in, out := &in.SetHeaderRouting, &out.SetHeaderRouting
		*out = new(SetHeaderRouting)
		(*in).DeepCopyInto(*out)
	}
	if in.SetMirrorRoutes != nil {
		in, out := &in.SetMirrorRoutes, &out.SetMirrorRoutes
		*out = new(SetMirrorRoutes)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SetHeaderRouting) DeepCopyInto(out *SetHeaderRouting) {
	*out = *in
	if in.Match != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SetHeaderRouting.
func (in *SetHeaderRouting) DeepCopy() *SetHeaderRouting {
	if in == nil {
		return nil
	}
	out := new(SetHeaderRouting)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SetMirrorMatch) DeepCopyInto(out *SetMirrorMatch) {
	*out = *in
	if in.Method != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SetMirrorMatch.
func (in *SetMirrorMatch) DeepCopy() *SetMirrorMatch {
	if in == nil {
		return nil
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SetMirrorRoutes) DeepCopyInto(out *SetMirrorRoutes) {
	*out = *in
	if in.Routes != nil {
		in, out := &in.Routes, &out.Routes
		*out = make([]SetMirrorRoute, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SetMirrorRoutes.
func (in *SetMirrorRoutes) DeepCopy() *SetMirrorRoutes {
	if in == nil {
		return nil
	}
	out := new(SetMirrorRoutes)
