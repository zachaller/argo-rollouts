...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CalledInfo) DeepCopyInto(out *CalledInfo) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CalledInfo.
func (in *CalledInfo) DeepCopy() *CalledInfo {
	if in == nil {
		return nil
	}
	out := new(CalledInfo)
...
func (in *PluginStatus) DeepCopyInto(out *PluginStatus) {
	*out = *in
	...
	if in.CalledInfo != nil {
		in, out := &in.CalledInfo, &out.CalledInfo
		*out = new(CalledInfo)
		(*in).DeepCopyInto(*out)
	}
	if in.StatusRef != nil {
		in, out := &in.StatusRef, &out.StatusRef
		*out = new(ObjectRef)
		**out = **in
	}
	return
