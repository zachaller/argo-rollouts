...
func (in *CanaryStep) DeepCopyInto(out *CanaryStep) {
	*out = *in
	...
	if in.RemoveHeaderRoute != nil {
		in, out := &in.RemoveHeaderRoute, &out.RemoveHeaderRoute
		*out = new(RemoveHeaderRoute)
		**out = **in
	}
	...
	if in.RemoveMirrorRoute != nil {
		in, out := &in.RemoveMirrorRoute, &out.RemoveMirrorRoute
		*out = new(RemoveMirrorRoute)
		**out = **in
	}
	return
}
