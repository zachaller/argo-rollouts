...
func (in *CanaryStep) DeepCopyInto(out *CanaryStep) {
	*out = *in
	...
	if in.SetMirror != nil {
		in, out := &in.SetMirror, &out.SetMirror
		*out = new(SetMirror)
		(*in).DeepCopyInto(*out)
	}
	return
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SetMirror) DeepCopyInto(out *SetMirror) {
	*out = *in
	if in.Match != nil {
		in, out := &in.Match, &out.Match
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SetMirror.
func (in *SetMirror) DeepCopy() *SetMirror {
	if in == nil {
		return nil
	}
	out := new(SetMirror)
